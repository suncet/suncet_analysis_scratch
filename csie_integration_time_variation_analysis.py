"""
Load CSIE integration-time variation FITS from level0_5 and show all frames.
...
def main() -> None:
    ...
    data_dir = os.path.join(
        root, "test_data", "2026-04-22_integration_time_variation", "level0_5"
    )
    ...
    fig_w = min(4.2 * ncols, 24.0)
    fig_h = min(3.8 * nrows, 18.0)
    ...
    fig.suptitle("2026-04-22 CSIE integration-time variation - level0_5")
